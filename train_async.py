...
if __name__ == "__main__":
    ...
    parser.add_argument("--include_ram", type=str2bool, default=False)
    ...
    try:
        ...
        for current_sample_step in tqdm(range(params.max_sample_steps)):
            ...
            current_ram = get_env_ram(env) if args.include_ram else None
            ...
            data_queue.put(
                (
                    ...
                    episode_count,
                    {"ram": current_ram} if args.include_ram else None,
                )
            )
